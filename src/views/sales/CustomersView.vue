...
import { Search, Plus, Edit, Eye, EyeOff, BarChart2, Phone, Mail, User, MapPin, FileText, Clock, Trash2 } from 'lucide-vue-next'
...
async function handleDelete(row) {
  const ok = await confirm({
    ...
    message: `"${row.name}" mijozni o'chirmoqchimisiz?`,
